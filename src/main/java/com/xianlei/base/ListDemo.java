...
public class ListDemo {
	//add、addAll、clear、contains、containsAll、equals、get、
	//indexOf、isEmpty、iterator、lastIndexOf、remove、remove(firstObj)、removeAll(E)
	
	List list = new ArrayList();
	
	List safeList = Collections.synchronizedList(list);//转换成线程安全的list
...
//	replaceAll     Open Declaration java.util.function.UnaryOperator<T>
